...
public class StudentController {
    ...
    @PreAuthorize("hasRole('ADMIN')")//sadece ROLE_ADMIN bu isteği yapabilir.
    @GetMapping
...
// (Entity obje<->JSON)-->Jackson
    ...
    //5-belirli bir id ile studentı görüntüleyelim + Request Param
    ...
    //5(2.yöntem)-belirli bir id ile studentı görüntüleyelim +Path Param
    ...
    //7-belirli bir id ile studentı silelim +Path Param
    ...
    //9-belirli bir id ile studentı update edelim.(name,lastName,grade,email,phoneNumber)
    ...
    //parametrelerin girilmesi opsiyonel olduğunda default value vermeliyiz.(defaultValue = "0")
    ...
    public ResponseEntity<StudentDTO> getStudentDtoById(@PathVariable("id") Long id){
       ...
       logger.warn("--------serviceden StudentDTO objesi alındı: "+studentDTO.getName());
